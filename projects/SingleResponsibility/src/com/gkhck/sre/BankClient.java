package com.gkhck.sre;

import java.util.Scanner;

/**
 * 
 * BankClient is responsible for I/O processing
 * 
 **/
...
public class BankClient {
	...
	public void run() {
		...
		while (!done) {
			...
			System.out.print("Enter command (0=quit , 1=new, 2=select, 3=deposit, 4=loan,"
					+ "5=show, 6=interest):");
	...
	private void authorizeLoan() {
		...
		if(bank.authorizeLoan(current, loanamt)) {
			System.out.println("Yout loan is approved");
		}
		else {
